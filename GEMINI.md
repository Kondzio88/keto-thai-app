...
- Na samym poczatku pracy czytaj jeśli jest w projekcie pliki PLAN.md, STRATEGY.md, PROGRES.md, DESIGN.md oraz MARKETING.md żebyś dobrze wiedział co robimy.
...
- Cały nasz design aplikacji poznasz w pliku DESIGN.md . trzymamy sie tego wyglądu aplikacji. Ważne zasady copywritingu i konwersji znajdziesz w MARKETING.md.
